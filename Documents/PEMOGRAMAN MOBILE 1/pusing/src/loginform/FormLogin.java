...
import pusing.Kalkulator;
import javatech.pk.PlayerFrame;
...
public class FormLogin extends javax.swing.JFrame {
    ...
    if(rs.next()){
    this.dispose();
    String coba = (String)CmbItem.getSelectedItem();
        if(coba.equals("Kalkulator Sederhana")){
        Kalkulator k = new Kalkulator();
        this.setVisible(false);
        k.setVisible(true);
        }
        else if(coba.equals("Music Player MP3")){
        PlayerFrame k = new PlayerFrame();
        this.setVisible(false);
        k.setVisible(true); 
        }else{
        JOptionPane.showMessageDialog(rootPane, "Anda tidak memilih program", "Pesan",JOptionPane.ERROR_MESSAGE);
        }
        
    }else{
    JOptionPane.showMessageDialog(rootPane, "Akun anda belom terdaftar", "Pesan",JOptionPane.ERROR_MESSAGE);
    HapusLayar();
    }
    }
    }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnRegistrasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 340, 130, 40));

        CmbItem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "~ Pilih Program ~", "Kalkulator Sederhana", "Music Player MP3" }));
        jPanel2.add(CmbItem, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 336, 30));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel11.setText("Thank you for accessing the project");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 400, 420, -1));
        ...
        jPanel2.add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 130, 40));
